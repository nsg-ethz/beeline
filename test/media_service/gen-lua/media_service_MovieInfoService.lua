...
function MovieInfoServiceClient:WriteMovieInfo(req_id, movie_id, title, casts, plot_id, thumbnail_ids, photo_ids,
                                               video_ids, avg_rating, num_rating, carrier)
    self:send_WriteMovieInfo(req_id, movie_id, title, casts, plot_id, thumbnail_ids, photo_ids, video_ids, avg_rating,
        num_rating, carrier)
    self:recv_WriteMovieInfo(req_id, movie_id, title, casts, plot_id, thumbnail_ids, photo_ids, video_ids, avg_rating,
        num_rating, carrier)
end

function MovieInfoServiceClient:send_WriteMovieInfo(req_id, movie_id, title, casts, plot_id, thumbnail_ids, photo_ids,
                                                    video_ids, avg_rating, num_rating, carrier)
...
function MovieInfoServiceClient:recv_WriteMovieInfo(req_id, movie_id, title, casts, plot_id, thumbnail_ids, photo_ids,
                                                    video_ids, avg_rating, num_rating, carrier)
...
function MovieInfoServiceClient:send_UpdateRating(req_id, movie_id, sum_uncommitted_rating, num_uncommitted_rating,
                                                  carrier)
...
function MovieInfoServiceClient:recv_UpdateRating(req_id, movie_id, sum_uncommitted_rating, num_uncommitted_rating,
                                                  carrier)
    local fname, mtype, rseqid = self.iprot:readMessageBegin()
    if mtype == TMessageType.EXCEPTION then
        local x = TApplicationException:new {}
...
function MovieInfoServiceProcessor:process_WriteMovieInfo(seqid, iprot, oprot, server_ctx)
    ...
    iprot:readMessageEnd()
    local result = WriteMovieInfo_result:new {}
    local status, res = pcall(self.handler.WriteMovieInfo, self.handler, args.req_id, args.movie_id, args.title,
        args.casts, args.plot_id, args.thumbnail_ids, args.photo_ids, args.video_ids, args.avg_rating, args.num_rating,
        args.carrier)
    if not status then
...
function MovieInfoServiceProcessor:process_UpdateRating(seqid, iprot, oprot, server_ctx)
    ...
    iprot:readMessageEnd()
    local result = UpdateRating_result:new {}
    local status, res = pcall(self.handler.UpdateRating, self.handler, args.req_id, args.movie_id,
        args.sum_uncommitted_rating, args.num_uncommitted_rating, args.carrier)
    if not status then
        reply_type = TMessageType.EXCEPTION
        result = TApplicationException:new { message = res }
    elseif ttype(res) == 'ServiceException' then
